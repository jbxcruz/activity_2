...
snowmanMiddle.position.set(2, 0, 5) // Positioned above the bottom sphere
...
snowmanHead.position.set(2, 0, 5) // Positioned above the middle sphere
...
// Position snowman
snowman.position.set(0.5, -2, -1) // You can adjust this position to move the snowman around
